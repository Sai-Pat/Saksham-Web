...
export default function AdminLogin() {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            // Fallback check for officer if needed
            ...
            <div className="w-full md:w-1/2 bg-white flex items-center justify-center p-8">
                <div className="w-full max-w-md bg-white rounded-2xl shadow-xl md:shadow-none p-8 border border-gray-100 md:border-none">
                    <div className="text-center mb-10">
                        <h2 className="text-2xl font-bold text-govt-blue-dark inline-block border-b-4 border-govt-blue-dark pb-2">ADMIN LOGIN</h2>
                    </div>
