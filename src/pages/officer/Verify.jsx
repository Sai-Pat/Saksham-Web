...
export default function OfficerVerify() {
    ...
    const handleVerify = async (e) => {
        ...
        if (profile?.role !== 'officer') {
            ...
            setError('Unauthorized: You are not an Officer.')
            setLoading(false)
            return
        }
        ...
        <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-green-50 via-white to-orange-50 p-4">
            ...
            >
                <div className="mb-8 text-center">
                    ...
                    <h2 className="text-3xl font-bold text-green-800">Verify Officer Access</h2>
                    ...
                    <form onSubmit={handleVerify} className="space-y-6">
                        <div>
                            ...
                            <input
                                ...
                                required
                                className="mt-2 block w-full rounded-lg border-2 border-gray-300 bg-white px-4 py-3 text-gray-900 shadow-sm transition-all focus:border-green-500 focus:outline-none focus:ring-2 focus:ring-green-500/20"
                            />
                        </div>
                        <div>
                            ...
                            <input
                                ...
                                required
                                maxLength={6}
                                className="mt-2 block w-full rounded-lg border-2 border-gray-300 bg-white px-4 py-3 text-center text-2xl font-mono tracking-widest text-gray-900 shadow-sm transition-all focus:border-green-500 focus:outline-none focus:ring-2 focus:ring-green-500/20"
                                placeholder="000000"
                            />
                        </div>
